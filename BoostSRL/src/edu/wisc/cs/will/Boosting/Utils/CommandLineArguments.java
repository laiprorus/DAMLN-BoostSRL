...
public class CommandLineArguments {
	...
	public static final String useDomainSizeScaling = "dss";
	private boolean domainSizeScaling=false;
	...
	public boolean parseArgs(String[] args) {
		for (int i = 0; i < args.length; i++) {		
			...
			if (argMatches(args[i], useDomainSizeScaling)) {
				domainSizeScaling = true;
				continue;
			}
	...
	public boolean isDomainSizeScaling() {
		return domainSizeScaling;
	}
